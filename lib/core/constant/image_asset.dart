class AppImageAsset {
  ...
  static const String onBoardingImageOne = "$rootImages/aa.gif";
  static const String onBoardingImageTwo = "$rootImages/ss.gif";
  static const String onBoardingImageThree = "$rootImages/xx.gif";
